...
namespace EventPublisherEF.DataRepository
{
    interface IEventRepository
    {
        ...
        void CreateEvent(string name, string description, string cityName, string placeName, string type, System.DateTime startDate, System.DateTime endDate, bool approved);
        void UpdateEvent(int id, string name, string description, string cityName, string placeName, string type, System.DateTime startDate, System.DateTime endDate, bool approved);
        ...
        void AddPlace(string placeName, string cityName);
        void DeletePlace(int id);

        List<GetPublishersByNames> GetPublisherInfo();
        void DeletePublisher(int id);
        void CreatePublisher(string name, string companyName, string email, string cityName, string phoneNumber, string idUser);
        void UpdatePublisher(int id, string name, string companyName, string email, string cityName, string phoneNumber, string idUser);
